  ...
  if (!mapsModule) {
    return (
      <View style={[styles.container, styles.webFallback]}>
        <Text variant="headlineSmall" style={styles.webFallbackTitle}>
          Harta mobile nuk mbështetet në shfletues
        </Text>
        <Text variant="bodyMedium" style={styles.webFallbackBody}>
          Hapni aplikacionin në një pajisje mobile për të parë pikët interaktive në hartë.
        </Text>
      </View>
    );
  }

  const { MapView, Marker, Callout } = mapsModule;
...
const styles = StyleSheet.create({
  ...
  webFallbackBody: webFallbackText,
});
